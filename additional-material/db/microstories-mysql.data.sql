...
genre, primaryTheme, secondaryTheme) VALUES
	('Microrrelato 1','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam vel cursus nunc. Nam posuere mauris quis odio maximus, non pharetra ipsum semper. Mauris vel augue a nunc lacinia faucibus et efficitur quam. Sed interdum ex vitae porta maximus. Maecenas tincidunt sed nulla sed tincidunt. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus eleifend posuere.','Autor 1', '2012-06-18',
	'STORY', 'HISTORY','CHILDREN'),
	('Microrrelato 2','Lorem ipsum dolor sit posuere.','Autor 2', '1999-01-24',
	'NANOSTORY', 'ADVENTURE', 'ROMANTIC'),
	('Microrrelato 3','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vestibulum id sed.','Autor 3', '2005-03-09',
	'POETRY', 'THRILLER', 'CHILDREN'),
	('Microrrelato 4','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam vel cursus nunc. Nam posuere mauris quis odio maximus, non pharetra ipsum semper. Mauris vel augue a nunc lacinia faucibus et efficitur quam. Sed interdum ex vitae porta maximus. Maecenas tincidunt sed nulla sed tincidunt. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus eleifend posuere.','Autor 4', '2016-11-13',
	'STORY', 'CHILDREN', 'ROMANTIC'),
	('Microrrelato 5','Lorem ipsum dolor sit posuere.','Autor 5', '2009-08-30',
	'NANOSTORY', 'HORROR', 'THRILLER'),
	('Microrrelato 6','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vestibulum id sed.','Autor 6', '2015-10-02',
	'POETRY', 'HORROR', 'HISTORY'),
	('Microrrelato 7','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vestibulum id sed.','Autor 7', '2002-10-02',
